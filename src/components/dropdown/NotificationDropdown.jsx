...
const NotificationDropdown = () => {
  return (
   ...
   >
       <div className="py-2">
           <Link to="/" className="flex items-center px-4 py-3 -mx-2 transition-colors duration-300 transform border-b border-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-700">
               ...
               <p className="mx-2 text-sm text-gray-600 dark:text-white"><span className="font-bold" to="/">Sara Salah</span> replied on the <span className="text-blue-500 hover:underline" to="/">Upload Image</span> artical . 2m</p>
           </Link>
           <Link to="/" className="flex items-center px-4 py-3 -mx-2 transition-colors duration-300 transform border-b border-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-700">
               ...
               <p className="mx-2 text-sm text-gray-600 dark:text-white"><span className="font-bold" to="/">Slick Net</span> start following you . 45m</p>
           </Link>
           <Link to="/" className="flex items-center px-4 py-3 -mx-2 transition-colors duration-300 transform border-b border-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-700">
               ...
               <p className="mx-2 text-sm text-gray-600 dark:text-white"><span className="font-bold" to="/">Jane Doe</span> Like Your reply on <span className="text-blue-500 hover:underline" to="/">Test with TDD</span> artical . 1h</p>
           </Link>
           <Link to="/" className="flex items-center px-4 py-3 -mx-2 transition-colors duration-300 transform hover:bg-gray-100 dark:hover:bg-gray-700">
               ...
               <p className="mx-2 text-sm text-gray-600 dark:text-white"><span className="font-bold" to="/">Abigail Bennett</span> start following you . 3h</p>
           </Link>
       </div>
       <Link to="/" className="block py-2 font-bold text-center text-white bg-gray-800 dark:bg-gray-700 hover:underline">See all notifications</Link>
   </div>
</div>
    </div>
  )
