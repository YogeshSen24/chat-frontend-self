...
const GroupList = () => {
    ...
    return (
        <div className="h-screen py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700">
            ...
            <h2 className="px-5 text-lg font-medium text-gray-800 dark:text-white">Groups</h2>
            ...
            <div className="mt-8 space-y-4">
                {
                    GroupsListData.length<1&& <h4 className="px-5 text-sm font-bold text-gray-400 ">You dont have any friends yet!!!</h4>
                }
                {
