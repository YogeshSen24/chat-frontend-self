...
const messageBubble = ({ name = "user" , profileImg = defaultImg , message="this is demo message" , status="pending" , time="00:00"}) => {
  ...
  return (
    <div className="flex m-2 items-start gap-2.5">
    ...
    <div id="dropdownDots" className={`z-10 ${options?"" : "hidden"} bg-white divide-y divide-gray-100 rounded-lg shadow w-40 dark:bg-gray-700 dark:divide-gray-600`}>
